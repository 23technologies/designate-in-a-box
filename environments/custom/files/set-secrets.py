...
SECRETSFILE_OUTPUT_OPENSTACK = '/opt/configuration/environments/openstack/secure.yml'
...
secrets_output_openstack['clouds']['admin']['auth']['password'] = secrets_input['keystone_admin_password']
